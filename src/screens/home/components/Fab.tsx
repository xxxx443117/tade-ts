...
const Fab: React.FC<FabProps> = ({ show, setShow }) => {
            ...
            <Box position="absolute" top={0} width="100%">
              <Center>
                ...
                <Row
                  ...
                  alignItems="flex-end"
                >
                  <Text color="#FFD5AF" bold paddingBottom="13px">
                    R$
                  </Text>
                  <Text color="#FFD5AF" bold fontSize="68px" lineHeight="68px">
                    68
                  </Text>
                  <Box height="100%">
                    <Box
